...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "app/data/service_account_key.json"
...
def get_data():
    ...
    if response == False:
        ...
        filename = f'LBA/{today.strftime("%Y-%m-%d")}.json'
        json_str = create_json(departures)
        gcs_upload(filename, json_str)
